...
public class TelaCadastroCarro extends JFrame {
	...
	public TelaCadastroCarro() {
		...
		lblNomeCli = new JLabel("Nome cliente");
		lblNomeCli.setBounds(10, 83, 60, 14);
		...
		btnCriar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try{
					...
					Carro c = Sistema.cadastrarCarro(placa, modelo, nome);
					JOptionPane.showMessageDialog(null,"cadastrado "+c.getPlaca());
